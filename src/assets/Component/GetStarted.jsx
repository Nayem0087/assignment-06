    ...
    return (
        <div>
            ...
            <div className='max-w-[80%] mx-auto grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 mb-20'>
                <div className='ring-1 ring-gray-100 shadow-2xl rounded-lg flex flex-col text-center p-4'>
                ...
                <div className='ring-1 ring-gray-100 shadow-2xl flex flex-col text-center p-4'>
                    <button className='flex justify-end'>
